  ...
  return (
    <div className=" w-64  md:w-72   bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
      <img
        ...
        loading="lazy"
        alt={name}
        className=" size-64  md:h-80 md:w-full object-cover rounded-t-xl"
      />
      <div className="px-4 py-3 w-64 md:w-72">
        <span className="text-gray-400 mr-3 uppercase text-xs">
          {productBrand.name}
        </span>
        <NavLink to={`/product-detail/${id}`}>
          <p className=" text-base md:text-lg font-bold text-black truncate  hover:underline block capitalize">
            {name}
          </p>
        </NavLink>
