...
export default function SkeletonOrderProductCard() {
  return (
    <div className="bg-white border border-l-0 border-r-0 border-b-0 border-t-zinc-200 p-6 flex gap-2.5 animate-pulse">
      {/* Skeleton Image */}
      <div className="flex-shrink-0 size-28  sm:size-40  bg-gray-200 rounded-lg relative mt-4 shadow">
      ...
      <div className="mt-4  flex flex-col space-y-4">
        ...
        <div className="flex justify-between items-start">
          <div className="space-y-2">
            ...
            <div className="h-3  w-40  sm:w-72 bg-gray-200 rounded"></div>
          </div>
          <div className="h-4 w-16 ml-3 sm:ml-0 bg-gray-300 rounded"></div>
        </div>
