...
import { addressSelectors, deleteUserAddressThunk, fetchUserAddress, registerUserAddressThunk, resetAddressAddStatus, resetAddressErrors, updateUserAddressThunk } from "../redux-store/slices/address/addressSlice";
...
function Profile() {
  ...
  return (
    <div
      className="w-[800px]  p-4 mt-20 mx-auto  rounded-2xl"
      style={{
        boxShadow:
    ...
    >
      ...
      {addAddress && <AddAddress setFalse={setAddAddress} handleChange={handleregisterAddress} />}
      {address ? (
        editAddress ? (
          <UpdateAddress setFalse={setEditAddress} handleUpdateAddress={handleUpdateAddress}  />
        ) : (
          <AddressInfo setEditAddress={setEditAddress} handleAddressDelete={handleAddressDelete} />
        )
      ) : (
